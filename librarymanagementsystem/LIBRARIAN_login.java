...
public class LIBRARIAN_login implements ActionListener{
    ...
    String Password;
     ...
     LIBRARIAN_login(){
        ...
        label1= new JLabel("Librarian ID: ");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(s.equals("maheen") && p.equals("123")){
            frame.dispose();
              LibrarianSucces li=new LibrarianSucces();
          
         }
        
         if(s.equals("mayaa") && p.equals("123")){
            frame.dispose();
              LibrarianSucces li=new LibrarianSucces();
